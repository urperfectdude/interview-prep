...
- Solo-developer / MVP scope: no team accounts, billing, or multi-tenant auth in this release — a session is identified by its own id, not a login system.
...
- No persistent user accounts/authentication in this release; a session is self-contained.
